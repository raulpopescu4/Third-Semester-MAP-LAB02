...
public class Interpreter {
    ...
    public static void main(String[] args){
        ...
        iRepository firstRepository = new Repository(firstState);
        ...
        iRepository secondRepository = new Repository(secondState);
        ...
        iRepository thirdRepository = new Repository(thirdState);
